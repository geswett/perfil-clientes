...
defecto se usa gemini-2.5-pro en ambos casos.
"""
...
MODEL_MULTIMODAL = os.environ.get("GEMINI_MODEL_MULTIMODAL", "gemini-2.5-pro")
MODEL_TEXT = os.environ.get("GEMINI_MODEL_TEXT", "gemini-2.5-pro")
